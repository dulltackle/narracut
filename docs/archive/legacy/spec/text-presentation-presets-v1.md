...
> **Legacy，已被 [ADR-0008](../../../adr/0008-project-vnext-normative-architecture.md) 与 [`project-vnext.md`](../../../spec/project-vnext.md) 替代。** 本文件只冻结 Project DSL V3 的旧表现，不属于当前规范；Project VNext 不兼容或自动迁移 Text Preset，也不继承固定 Composition。
