...
> **状态：Legacy，已由 [ADR-0009](../../../adr/0009-separate-scene-content-and-render-program-authority.md) 替代。** Project VNext 不保存任何 Visual Type、Card 或 Caption；全部成片表现归 Render Program，也不提供旧 Visual 的兼容或迁移路径。
